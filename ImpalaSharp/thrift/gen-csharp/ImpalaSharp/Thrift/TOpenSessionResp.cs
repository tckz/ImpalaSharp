...
namespace ImpalaSharp.Thrift
{
  ...
  public partial class TOpenSessionResp : TBase
  {
    ...
    public TOpenSessionResp() {
      this.ServerProtocolVersion = TProtocolVersion.HIVE_CLI_SERVICE_PROTOCOL_V1;
    }
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Configuration != null && __isset.configuration) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (string _iter71 in Configuration.Keys)
          {
            oprot.WriteString(_iter71);
            oprot.WriteString(Configuration[_iter71]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
