...
namespace ImpalaSharp.Thrift
{
  public partial class TCLIService {
    public interface Iface {
      ...
      #endif
      TGetLogResp GetLog(TGetLogReq req);
      #if SILVERLIGHT
      IAsyncResult Begin_GetLog(AsyncCallback callback, object state, TGetLogReq req);
      TGetLogResp End_GetLog(IAsyncResult asyncResult);
      #endif
    }
    ...
    public class Client : IDisposable, Iface {
      ...
      #if SILVERLIGHT
      public IAsyncResult Begin_GetLog(AsyncCallback callback, object state, TGetLogReq req)
      {
        return send_GetLog(callback, state, req);
      }

      public TGetLogResp End_GetLog(IAsyncResult asyncResult)
      {
        oprot_.Transport.EndFlush(asyncResult);
        return recv_GetLog();
      }
      ...
      public TGetLogResp GetLog(TGetLogReq req)
      {
        ...
        #else
        var asyncResult = Begin_GetLog(null, null, req);
        return End_GetLog(asyncResult);

        #endif
      }
      #if SILVERLIGHT
      public IAsyncResult send_GetLog(AsyncCallback callback, object state, TGetLogReq req)
      #else
      public void send_GetLog(TGetLogReq req)
      #endif
      {
      ...
      public TGetLogResp recv_GetLog()
      {
        TMessage msg = iprot_.ReadMessageBegin();
        if (msg.Type == TMessageType.Exception) {
          TApplicationException x = TApplicationException.Read(iprot_);
    ...
    public class Processor : TProcessor {
      ...
      public void GetInfo_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        iprot.ReadMessageEnd();
        GetInfo_result result = new GetInfo_result();
        result.Success = iface_.GetInfo(args.Req);
      ...
      public void GetTypeInfo_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        GetTypeInfo_args args = new GetTypeInfo_args();
        args.Read(iprot);
        iprot.ReadMessageEnd();
        GetTypeInfo_result result = new GetTypeInfo_result();
        result.Success = iface_.GetTypeInfo(args.Req);
      ...
      public void GetCatalogs_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        GetCatalogs_args args = new GetCatalogs_args();
        args.Read(iprot);
        iprot.ReadMessageEnd();
        GetCatalogs_result result = new GetCatalogs_result();
        result.Success = iface_.GetCatalogs(args.Req);
      ...
      public void GetSchemas_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        GetSchemas_args args = new GetSchemas_args();
        args.Read(iprot);
        iprot.ReadMessageEnd();
        GetSchemas_result result = new GetSchemas_result();
        result.Success = iface_.GetSchemas(args.Req);
      ...
      public void GetTables_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        iprot.ReadMessageEnd();
        GetTables_result result = new GetTables_result();
        result.Success = iface_.GetTables(args.Req);
      ...
      public void GetTableTypes_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        GetTableTypes_args args = new GetTableTypes_args();
        args.Read(iprot);
        iprot.ReadMessageEnd();
        GetTableTypes_result result = new GetTableTypes_result();
        result.Success = iface_.GetTableTypes(args.Req);
      ...
      public void GetColumns_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        iprot.ReadMessageEnd();
        GetColumns_result result = new GetColumns_result();
        result.Success = iface_.GetColumns(args.Req);
      ...
      public void GetFunctions_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        GetFunctions_args args = new GetFunctions_args();
        args.Read(iprot);
        iprot.ReadMessageEnd();
        GetFunctions_result result = new GetFunctions_result();
        result.Success = iface_.GetFunctions(args.Req);
      ...
      public void GetOperationStatus_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        GetOperationStatus_args args = new GetOperationStatus_args();
        args.Read(iprot);
        iprot.ReadMessageEnd();
        GetOperationStatus_result result = new GetOperationStatus_result();
        result.Success = iface_.GetOperationStatus(args.Req);
      ...
      public void GetResultSetMetadata_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        GetResultSetMetadata_args args = new GetResultSetMetadata_args();
        args.Read(iprot);
        iprot.ReadMessageEnd();
        GetResultSetMetadata_result result = new GetResultSetMetadata_result();
        result.Success = iface_.GetResultSetMetadata(args.Req);
      ...
      public void GetLog_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        iprot.ReadMessageEnd();
        GetLog_result result = new GetLog_result();
        result.Success = iface_.GetLog(args.Req);
    ...
    public partial class GetTypeInfo_args : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("GetTypeInfo_args");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
        if (Req != null && __isset.req) {
          field.Name = "req";
    ...
    public partial class GetTypeInfo_result : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("GetTypeInfo_result");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
    ...
    public partial class GetCatalogs_args : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("GetCatalogs_args");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
        if (Req != null && __isset.req) {
          field.Name = "req";
    ...
    public partial class GetCatalogs_result : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("GetCatalogs_result");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
    ...
    public partial class GetSchemas_args : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("GetSchemas_args");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
        if (Req != null && __isset.req) {
          field.Name = "req";
    ...
    public partial class GetSchemas_result : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("GetSchemas_result");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
    ...
    public partial class GetTableTypes_args : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("GetTableTypes_args");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
        if (Req != null && __isset.req) {
          field.Name = "req";
    ...
    public partial class GetTableTypes_result : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("GetTableTypes_result");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
    ...
    public partial class GetFunctions_args : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("GetFunctions_args");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
        if (Req != null && __isset.req) {
          field.Name = "req";
    ...
    public partial class GetFunctions_result : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("GetFunctions_result");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
    ...
    public partial class GetOperationStatus_args : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("GetOperationStatus_args");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
        if (Req != null && __isset.req) {
          field.Name = "req";
    ...
    public partial class GetOperationStatus_result : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("GetOperationStatus_result");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
    ...
    public partial class GetResultSetMetadata_args : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("GetResultSetMetadata_args");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
        if (Req != null && __isset.req) {
          field.Name = "req";
    ...
    public partial class GetResultSetMetadata_result : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("GetResultSetMetadata_result");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
    ...
    {
      private TGetLogReq _req;

      public TGetLogReq Req
      {
        get
        {
          return _req;
    ...
    {
      private TGetLogResp _success;

      public TGetLogResp Success
      {
        get
        {
          return _success;
