...
namespace ImpalaSharp.Thrift.Hive
{
  ...
  [Serializable]
  #endif
  public partial class DoubleColumnStatsData : TBase
  {
    ...
    public DoubleColumnStatsData(double lowValue, double highValue, long numNulls, long numDVs) : this() {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("DoubleColumnStatsData");
      ...
      oprot.WriteDouble(LowValue);
      oprot.WriteFieldEnd();
      field.Name = "highValue";
      field.Type = TType.Double;
      field.ID = 2;
      oprot.WriteFieldBegin(field);
      oprot.WriteDouble(HighValue);
      oprot.WriteFieldEnd();
      field.Name = "numNulls";
