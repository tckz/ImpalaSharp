            ...
            if (field.Type == TType.List) {
              {
                ...
                {
                  FieldSchema _elem89 = new FieldSchema();
                  _elem89 = new FieldSchema();
                  _elem89.Read(iprot);
                  PartitionKeys.Add(_elem89);
                }
                iprot.ReadListEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (PartitionKeys != null && __isset.partitionKeys) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (FieldSchema _iter94 in PartitionKeys)
          {
            _iter94.Write(oprot);
          }
          oprot.WriteListEnd();
      ...
      if (Parameters != null && __isset.parameters) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (string _iter95 in Parameters.Keys)
          {
            oprot.WriteString(_iter95);
            oprot.WriteString(Parameters[_iter95]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
